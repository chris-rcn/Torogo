...
const { createState, policyMove } = _isNode ? require('../ppat-lib.js') : window.PPatterns;
...
function playTracked(game2, node, played) {
  ...
  while (!game2.gameOver && moves < moveLimit) {
    ...
    const idx = _weights ? policyMove(game2, _ppatState, _weights) : game2.randomLegalMove();
