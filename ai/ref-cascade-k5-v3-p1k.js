...
// Fixed-config reference agent: cascade (fp top-5 -> vlibpat top-3 -> 1000
...
function create() {
  ...
  const fpModel = FeaturePol.loadModel({ name: 'ref-cascade-k5-v3-p1k',
  ...
  console.log(`ref-cascade-k5-v3-p1k: fp=${fpWeights.size}w vlib=${vModel.weights.size}w ppat=${ppatModel.weights.length}w`);
