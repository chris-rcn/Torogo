...
// Fixed-config reference agent: cascade (fp top-3 -> vlibpat top-2 -> 100
...
function create() {
  ...
  const fpModel = FeaturePol.loadModel({ name: 'ref-cascade-k3-v2-p100',
  ...
  console.log(`ref-cascade-k3-v2-p100: fp=${fpWeights.size}w vlib=${vModel.weights.size}w ppat=${ppatModel.weights.length}w`);
