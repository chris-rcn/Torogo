...
// prodOldD: production agent 2026-08-19 → 2026-08-27 (puct-ppat: PUCT with
// npat priors and ppat playouts), retired when puct-ppat-fp was promoted to
// prod — featurepol priors rate ~65-90 Elo over npat at matched playouts on
// the 13x13 ladder.  Kept frozen for historical comparisons.
//
// Self-contained copy of ai/puct-ppat.js with hardcoded config; when promoted
// it beat the previous prod (rave-npat-prune, now ai/prodOldC.js) at equal
// time: 9×9 83%/100g @100ms, 87%/100g @300ms; 13×13 78%/37g @1s.
//
