...
// Fixed-config reference agent: cascade (fp top-30 -> vlibpat top-7 -> 1000
...
function create() {
  ...
  const fpModel = FeaturePol.loadModel({ name: 'ref-cascade-k30-v7-p1k',
  ...
  console.log(`ref-cascade-k30-v7-p1k: fp=${fpWeights.size}w vlib=${vModel.weights.size}w ppat=${ppatModel.weights.length}w`);
