...
const { weights, modelName } = NPat.loadModel({ name: 'npat', path: process.env.NPAT_DATA });
...
console.error(`npat: loaded ${weights.size} weights from ${modelName} (${NPat.cfgFlags(weights.cfg)})`);
