...
// top-3 moves, vlibpat picks the best of those by depth-1 value.  The
...
const { weights: fpWeights, modelName } = FeaturePol.loadModel({ name: 'ref-search-top3-fp', path: FP_PATH });

console.error(`ref-search-top3-fp: vlibpat=${vModel.weights.size}w featurepol=${fpWeights.size}w (${modelName})  top-K=${TOP_K}`);
