...
// Fixed-config reference agent: cascade (fp top-3 -> vlibpat top-2 -> 300
...
function create() {
  ...
  const fpModel = FeaturePol.loadModel({ name: 'ref-cascade-k3-v2-p300',
  ...
  console.log(`ref-cascade-k3-v2-p300: fp=${fpWeights.size}w vlib=${vModel.weights.size}w ppat=${ppatModel.weights.length}w`);
